...
const getGeneralEnquiryAdminAlertTemplate = (data) => {
    ...
    const rawService = data.service || data.enquiryType || '';
    const service = serviceLabels[String(rawService).toLowerCase()] || rawService || 'General Enquiry';
...
<head>
    ...
    <title>New General Enquiry Alert</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:800px;border:1px solid #d8dde6;border-collapse:separate;border-spacing:0;background-color:#ffffff;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;">
                                <tr>
                                    <td valign="top" style="padding:0;font-family:Arial,Helvetica,sans-serif;">
                                        <div style="margin:0;font-size:20px;line-height:25px;font-weight:800;color:#07162f;text-transform:uppercase;white-space:nowrap;">NEW GENERAL ENQUIRY ALERT</div>
                    ...
                    <tr>
                        <td style="padding:18px 26px 17px 26px;">
                            ...
                            <div style="display:block;width:100%;margin:0 0 24px 0;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:23px;color:#111827;">
                                A new General Enquiry regarding <strong>${escapeHtml(service)}</strong> has been received through the IHWE website. Please review the complete enquiry details provided below and coordinate with the concerned team to ensure a timely response and necessary follow-up.
                            </div>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border:1px solid #cfd7e3;border-radius:6px;border-collapse:separate;border-spacing:0;overflow:hidden;">
                                ...
                                ${detailRow('Enquiry Type', service, { valueColor: '#0757b7' })}
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f5f9ff" style="width:100%;margin-top:20px;border:1px solid #bed5f4;border-radius:6px;border-collapse:separate;border-spacing:0;background-color:#f5f9ff;">
                                <tr>
                                    <td style="padding:16px 18px;font-family:Arial,Helvetica,sans-serif;">
                                        <div style="margin:0 0 9px 0;font-size:16px;line-height:21px;font-weight:800;color:#0644a6;text-transform:uppercase;">&#9998;&nbsp;&nbsp; ENQUIRY MESSAGE</div>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;margin-top:10px;border-collapse:collapse;">
                                            <tr>
                                                <td width="50%" valign="top" style="width:50%;padding-right:20px;">
                                                    ${checkItem('Review the enquiry details')}
                                                    ${checkItem('Assign the enquiry to the relevant team')}
                                                </td>
                                                <td width="50%" valign="top" style="width:50%;padding-left:20px;">
                                                    ${checkItem('Contact the enquirer at the earliest')}
                                                    ${checkItem('Update the enquiry status in IHWE CRM')}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#fff9e8" style="width:100%;margin-top:20px;border:1px solid #ead89d;border-radius:6px;border-collapse:separate;border-spacing:0;background-color:#fff9e8;">
                                <tr>
                                    ...
                                    <td valign="top" style="padding:16px 18px 16px 10px;font-family:Arial,Helvetica,sans-serif;">
                                        <div style="margin:0 0 7px 0;font-size:16px;line-height:20px;font-weight:800;color:#946200;text-transform:uppercase;">IMPORTANT NOTE</div>
                                        <div style="font-size:14px;line-height:21px;color:#111827;">Please acknowledge and follow up promptly to ensure a professional response to every IHWE enquiry.</div>
                                    </td>
                                </tr>
                            </table>

                            <div style="margin-top:20px;padding-top:13px;border-top:1px solid #d8dde6;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:21px;color:#111827;">
                                Best Regards,<br>
...
module.exports = { getGeneralEnquiryAdminAlertTemplate };
