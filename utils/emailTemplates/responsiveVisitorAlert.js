// Mobile-responsive email template for visitor registration alerts

const getResponsiveVisitorAlertTemplate = (data) => {
...
module.exports = { getResponsiveVisitorAlertTemplate };
