...
class ConferenceTestimonialsService {
    async getTestimonials() {
        let data = await ConferenceTestimonial.findOne();
        if (!data) {
            data = new ConferenceTestimonial({
...
module.exports = new ConferenceTestimonialsService();
