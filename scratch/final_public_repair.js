...
const summaryStartMarker = '<div className="w-full">                                                            <div className="flex justify-between items-center mb-3">';
const componentEndMarker = 'export default BookAStand;';

const startIdx = content.indexOf(summaryStartMarker);
const lastEndIdx = content.lastIndexOf(componentEndMarker);

if (startIdx !== -1 && lastEndIdx !== -1) {
    const validHeader = content.substring(0, startIdx);

    const cleanSummaryInner = `<div className="w-full">                                                            <div className="flex justify-between items-center mb-3">
    ...
    fs.writeFileSync(filePath, validHeader + cleanSummaryInner);
    console.log('Public BookAStand.tsx Fixed and Truncated.');
} else {
