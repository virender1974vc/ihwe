...
router.patch('/:id/claim-submission', msmePmsSchemeController.updateClaimSubmission);
router.patch('/:id/sanction', msmePmsSchemeController.updateSanction);
router.patch('/:id/reimbursement', msmePmsSchemeController.updateReimbursement);
