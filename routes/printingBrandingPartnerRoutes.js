...
router.get('/', (req, res) => printingBrandingPartnerController.getContent(req, res));
router.post('/', verifyToken, (req, res) => printingBrandingPartnerController.saveContent(req, res));
