...
const exhibitorRegistrationController = require('../../controllers/exhibitor_seller/exhibitorRegistrationController');
...
router.put('/:id/msme', msmeUpload.single('udyamCertificate'), async (req, res) => {
    try {
        ...
        const updated = await require('../../models/exhibitor_seller/ExhibitorRegistration').findByIdAndUpdate(
            req.params.id,
            { msme: msmeData },
