...
async function seed() {
    ...
    let exists = await PrintingBrandingPartner.findOne();
    if (!exists) {
        await PrintingBrandingPartner.create(defaultData);
        console.log(`✅ Created Printing Branding Partner data`);
    } else {
        await PrintingBrandingPartner.findOneAndUpdate({}, defaultData);
        console.log(`🔄 Updated Printing Branding Partner data`);
    }
