...
const WhyVisitSchema = new mongoose.Schema({
    ...
    shortDescription: { type: String, default: 'Join IH&WE 2026 to experience the latest innovations and build lasting connections in the healthcare and wellness sector. okh!' },
