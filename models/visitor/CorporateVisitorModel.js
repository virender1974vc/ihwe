...
const CorporateVisitorSchema = new mongoose.Schema(
  {
    ...
    purposeOfVisit: {
      exploringBusiness: { type: Boolean, default: false },
      meetingExhibitors: { type: Boolean, default: false },
      attendingSeminar: { type: Boolean, default: false },
    ...
    areaOfInterest: {
      ...
      fitnessNutrition: { type: Boolean, default: false },
      bioMedicine: { type: Boolean, default: false },
      healthTech: { type: Boolean, default: false },
    },
