...
const internationalExhibitorSchema = new mongoose.Schema(
  {
    ...
    legalEntityType: { 
      type: String, 
      enum: [
        'Private Limited', 'Public Limited', 'LLC', 'LLP', 
        'Partnership', 'Proprietorship', 'Government Organization', 
        'Trade Association', 'Embassy / Delegation', 'Other'
      ]
    },
    ...
    stallRequirement: {
      ...
      preferredStallLocation: { type: String },
    ...
    billingDetails: {
      ...
      bookingAmountPaid: { type: String }, // In Dollars
...
module.exports = mongoose.model("InternationalExhibitor", internationalExhibitorSchema);
