const PsmAnnexureC = require('../../models/misc/PsmAnnexureC');
const PsmAnnexureD = require('../../models/misc/PsmAnnexureD');
const PsmDeclaration = require('../../models/misc/PsmDeclaration');
const PsmFeedbackReport = require('../../models/misc/PsmFeedbackReport');
const PsmUndertaking = require('../../models/misc/PsmUndertaking');
const PsmPreReceipt = require('../../models/misc/PsmPreReceipt');
const PsmMandateForm = require('../../models/misc/PsmMandateForm');
const PsmPfmsDetails = require('../../models/misc/PsmPfmsDetails');
const PsmCoveringLetter = require('../../models/misc/PsmCoveringLetter');
const PsmNarrativeFeedback = require('../../models/misc/PsmNarrativeFeedback');
...
const models = {
    ...
    'covering-letter': PsmCoveringLetter,
    'narrative-feedback': PsmNarrativeFeedback
};
