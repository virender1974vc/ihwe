...
class FAQController {
    ...
    async updateHeadings(req, res) {
        try {
            const data = await faqService.updateHeadings(req.body);
    ...
    async addItem(req, res) {
        try {
            const data = await faqService.addItem(req.body);
    ...
    async updateItem(req, res) {
        try {
            const data = await faqService.updateItem(req.params.itemId, req.body);
    ...
    async deleteItem(req, res) {
        try {
            await faqService.deleteItem(req.params.itemId);
