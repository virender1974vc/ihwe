...
// @access  Public
exports.getPosterPresentationData = async (req, res) => {
    try {
        let data = await PosterPresentation.findOne();
        if (!data) {
            data = await PosterPresentation.create({
                guidelines: [],
                topics: [],
                importantNotes: [],
                timeline: []
...
exports.updatePosterPresentationData = async (req, res) => {
    try {
