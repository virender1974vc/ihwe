const BusinessType = require("../../models/add_by_admin/BusinessType.js");
...
const getBusinessTypeById = async (req, res) => {
    try {
        const record = await BusinessType.findById(req.params.id);
...
const createBusinessType = async (req, res) => {
    try {
        const newRecord = new BusinessType(req.body);
...
const deleteBusinessType = async (req, res) => {
    try {
        const record = await BusinessType.findByIdAndDelete(req.params.id);
