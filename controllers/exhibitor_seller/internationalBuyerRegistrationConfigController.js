const InternationalBuyerRegistrationConfig = require('../../models/exhibitor_seller/InternationalBuyerRegistrationConfig');
...
class InternationalBuyerRegistrationConfigController {
    ...
    async getConfig(req, res) {
        try {
            ...
            const BusinessType = require('../../models/misc/BusinessType');
            const AnnualTurnover = require('../../models/misc/AnnualTurnover');
            const PrimaryProductInterest = require('../../models/misc/PrimaryProductInterest');
            const SecondaryProduct = require('../../models/misc/SecondaryProduct');
            const MeetingPriorityLevel = require('../../models/misc/MeetingPriorityLevel');
